                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            <div class="custom_select">
                                <select class="form-control select-active select2-hidden-accessible" data-select2-id="1"
                                    tabindex="-1" aria-hidden="true">
                                    <option value="" data-select2-id="3">Select an option...</option>
                                    ...
                                    data-select2-id="2" style="width: 636px;"><span class="selection"><span
                                            class="select2-selection select2-selection--single" role="combobox"
                                            aria-haspopup="true" aria-expanded="false" tabindex="0"
                                            aria-labelledby="select2-qld9-container"><span
                                                class="select2-selection__rendered" id="select2-qld9-container"
                                                role="textbox" aria-readonly="true" title="Select an option...">Select
                                                an option...</span><span class="select2-selection__arrow"
                                                role="presentation"><b
                                ...
                                <div class="form-group">
                                    <div class="custom_select">
                                        <select class="form-control select-active select2-hidden-accessible"
                                            ...
                                            <option value="" data-select2-id="6">Select an option...</option>
                                            <option value="AX">Aland Islands</option>
                                            <option value="AF">Afghanistan</option>
                                            <option value="AL">Albania</option>
                                            <option value="DZ">Algeria</option>
                                            ...
                                            dir="ltr" data-select2-id="5" style="width: auto;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single" role="combobox"
                                                    aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-labelledby="select2-otg6-container"><span
                                                        class="select2-selection__rendered" id="select2-otg6-container"
