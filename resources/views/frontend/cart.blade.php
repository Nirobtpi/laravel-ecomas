                                    ...
                                    <div class="form-group col-lg-12">
                                        <div class="custom_select">
                                            <select class="form-control select-active select2-hidden-accessible"
                                                ...
                                                <option value="" data-select2-id="3">Choose a option...</option>
                                                ...
                                                dir="ltr" data-select2-id="2" style="width: 636px;"><span
                                                    class="selection"><span
                                                        class="select2-selection select2-selection--single"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-labelledby="select2-b3oc-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-b3oc-container" role="textbox"
                                                            aria-readonly="true" title="Choose a option...">Choose a
