...
<body style="overflow: visible;">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="{{ asset('frontend/assets/imgs/theme/flag-fr.png')}}" alt="">Français</a>
                                        </li>
                            ...
                            <div id="news-flash" class="d-inline-block"
                                ...
                                <ul style="position: absolute; margin: 0px; padding: 0px; top: 0px;">
                                    ...
                                    <li style="margin: 0px; padding: 0px; height: 14px;">Trendy 25silver jewelry, save
                                        up 35% off today <a href="shop.html">Shop now</a></li>
                                    <li style="margin: 0px; padding: 0px; height: 14px;">Get great devices up to 50% off
                                        <a href="shop.html">View details</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="product-details.html">Hoodies &amp; Sweatshirts</a>
                                                    </li>
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"><i
                                        class="fi-rs-angle-small-down"></i></span><span class="menu-expand"></span><a
                                    href="#">Our Collections</a>
                                <ul class="dropdown" style="display: none;">
                                    <li class="menu-item-has-children"><span class="menu-expand"><i
                                                class="fi-rs-angle-small-down"></i></span><span
                                            class="menu-expand"></span><a href="#">Women's Fashion</a>
                                        <ul class="dropdown" style="display: none;">
                                            <li><a href="product-details.html">Dresses</a></li>
                                            <li><a href="product-details.html">Blouses &amp; Shirts</a></li>
                                    ...
                                    <li class="menu-item-has-children"><span class="menu-expand"><i
                                                class="fi-rs-angle-small-down"></i></span><span
                                            class="menu-expand"></span><a href="#">Men's Fashion</a>
                                        <ul class="dropdown" style="display: none;">
                                            <li><a href="product-details.html">Jackets</a></li>
                                            <li><a href="product-details.html">Casual Faux Leather</a></li>
                                            <li><a href="product-details.html">Genuine Leather</a></li>
                                    ...
                                    <li class="menu-item-has-children"><span class="menu-expand"><i
                                                class="fi-rs-angle-small-down"></i></span><span
                                            class="menu-expand"></span><a href="#">Technology</a>
                                        <ul class="dropdown" style="display: none;">
                                            <li><a href="product-details.html">Gaming Laptops</a></li>
                                            <li><a href="product-details.html">Ultraslim Laptops</a></li>
                                            <li><a href="product-details.html">Tablets</a></li>
    ...
    <footer class="main">
            ...
            <div class="container pt-15 pb-20">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <h5 class="mt-20 mb-10 fw-600 text-grey-4 wow fadeIn animated"
                                style="visibility: hidden; animation-name: none;">Contact</h5>
                            ...
                            <h5 class="mb-10 mt-30 fw-600 text-grey-4 wow fadeIn animated"
                                style="visibility: hidden; animation-name: none;">Follow Us</h5>
                    ...
                    <div class="col-lg-2 col-md-3">
                        <h5 class="widget-title wow fadeIn animated" style="visibility: hidden; animation-name: none;">
                            About</h5>
                    ...
                    <div class="col-lg-2  col-md-3">
                        <h5 class="widget-title wow fadeIn animated" style="visibility: hidden; animation-name: none;">
                            My Account</h5>
                        <ul class="footer-list wow fadeIn animated" style="visibility: hidden; animation-name: none;">
                    ...
                    <div class="col-lg-4 mob-center">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-lg-12">
                                <p class="wow fadeIn animated" style="visibility: hidden; animation-name: none;">From
                                    App Store or Google Play</p>
                                <div class="download-app wow fadeIn animated mob-app"
                                    style="visibility: hidden; animation-name: none;">
                                    <a href="#" class="hover-up mb-sm-4 mb-lg-0"><img class="active"
                                            src="{{ asset('frontend/assets/imgs/theme/app-store.jpg')}}" alt=""></a>
                                    <a href="#" class="hover-up"><img src="{{ asset('frontend/assets/imgs/theme/google-play.jpg')}}"
                                            alt=""></a>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                                <p class="mb-20 wow fadeIn animated" style="visibility: hidden; animation-name: none;">
        ...
        <div class="container pb-20 wow fadeIn animated mob-center" style="visibility: hidden; animation-name: none;">
            <div class="row">
    ...
    <!-- Template  JS -->
    <script src="{{ asset('frontend/assets/js/main.js?v=3.3')}}"></script><a id="scrollUp" href="#top"
        style="position: fixed; z-index: 2147483647; display: none;"><i class="fi-rs-arrow-up"></i></a>
